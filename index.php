...
<?php include 'includes/opensection.php' ?>
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Ordinateur<br>Collection</h3>
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Ordinateurs portables</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">bonne affaire cette semaine</h2>
							<p>Nouvelle produit Jusqu'à 50% de réduction</p>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Ordinateurs portables</a></li>
		...
		<div class="section">
			...
			<div class="container">
				...
				<!-- /row -->
<?php include 'includes/endsection.php' ?>
